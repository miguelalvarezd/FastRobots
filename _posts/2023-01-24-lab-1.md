...
uuid4()
```
The files `connection.yaml` and `ble_arduino.ino` will look as follows, respectively:

<img src="{{ site.baseurl }}/assets/images/lab1/connection_yaml.png" alt="connection.yaml file.">
<img src="{{ site.baseurl }}/assets/images/lab1/ble_arduino.png" alt="ble_arduino.ino file.">
