...
In my case, the board sent 341 messages in 5 seconds. Each message was a string of 8 characters; which means each string is 64 bits. Therefore, the data transfer rate is (21824 bits / 5 seconds)= 4365 bits/s = 4.26kbps.
