...
*Note: As you may have noticed, some videos have a cable connected to the robot. This is because, when recording those videos, the battery powering the Artemis broke down, so I needed to power the board from an external source.*