...
With the extrapolation, the frequency of the system is around 100Hz. I will implement a Low Pass Filter in the derivative action to get rid of any possible noise above 100Hz. We don't have to worry about derivative kick as the SetPoint is constant.
