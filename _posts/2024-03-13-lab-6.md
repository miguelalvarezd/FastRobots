...
I will run a test with very fast angular speeds, and different values of myFSS.g (defined with a number from 1 to 4, corresponding to each limit, with Bluetooth). We can see that the speed is capped in both dps250 and dps500; but it doesn't get past 1000dps, which will be my maximum angular speed.
