...
After these tests, I realized an Integrator was also needed, to get faster to the SetPoint, as by merely increasing Kp the robot would oscillate.

**3. Kp = 1; Ki = 0.65; Kd = 0.65**
